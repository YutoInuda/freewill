;メッセージレイヤの定義
		...
		[position width=730 height=153 top=435 left=117 ]


		
			[position page=fore frame="textwidow1.png" margint=45 marginl=10 marginr=20 marginb=10 vertical=false ]
		...
		[position layer="message1" width=730 height=153 top=435 left=117 ]
